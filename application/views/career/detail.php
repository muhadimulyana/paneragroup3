<style>
	#topnav {
		background-color: rgb(104, 110, 154, 0.4);
	}
...
<section class="section"
	style="background-image:url('<?= base_url(); ?>assets/images/career/bg.png'); background-size: cover; min-height: 500px; background-position: center;">
	<div class="container pb-lg-4 mb-md-5 mt-5">
		<div class="row">
			...
			<div class="col-md-6 order-1 order-md-2 text-center">
				<img src="<?= base_url(); ?>assets/images/career/vector-01.svg" class="img-fluid" alt="">
			</div>
		</div>
	</div>
				...
				<div class="ml-lg-4">
					...
					<div class="mt-4">
						<a href="javascript:void(0)" class="btn text-white btn-pills"
							style="background-color: #282c73 !important;">hrd.era@paneragroup.com</a>
					</div>
				</div>
			</div>
			<!--end col-->
