	...
	<div class="container pb-lg-4 mb-md-5 mt-5">
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <h1 class="heading text-white m-0">We Are <span class="text-xl-career text-white">Hiring</span></h1>
...
<section class="section" style="background-image:url('<?= base_url(); ?>assets/images/career/work.jpeg'); background-size: cover; min-height: 500px; background-position: center;">
